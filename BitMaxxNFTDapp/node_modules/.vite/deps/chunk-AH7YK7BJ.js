...
var require_ethers = __commonJS({
  "node_modules/ethers/lib/ethers.js"(exports) {
    ...
    var wallet_1 = (init_lib7(), __toCommonJS(lib_exports7));
    Object.defineProperty(exports, "Wallet", { enumerable: true, get: function() {
      return wallet_1.Wallet;
    } });
    var constants = __importStar((init_lib3(), __toCommonJS(lib_exports3)));
    exports.constants = constants;
    var providers = __importStar((init_lib8(), __toCommonJS(lib_exports8)));
    exports.providers = providers;
    var providers_1 = (init_lib8(), __toCommonJS(lib_exports8));
    Object.defineProperty(exports, "getDefaultProvider", { enumerable: true, get: function() {
      return providers_1.getDefaultProvider;
    } });
    var wordlists_1 = (init_lib6(), __toCommonJS(lib_exports6));
...
var InjectedConnector = class extends Connector {
  ...
  async getSigner() {
    ...
    return new lib_exports8.Web3Provider(provider).getSigner(account);
  }
  async isAuthorized() {
    try {
...
function fallbackProvider(targetQuorum, minQuorum, providers_, _ref4) {
  ...
  try {
    return new lib_exports8.FallbackProvider(providers_.map((chainProvider, index) => {
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-AH7YK7BJ.js.map
